 ...
 */
export async function mobileDragGesture(elementId, startX, startY, endX, endY, speed) {
 ...
 */
export async function mobileFlingGesture(direction, elementId, left, top, width, height, speed) {
 ...
 */
export async function mobilePinchCloseGesture(percent, elementId, left, top, width, height, speed) {
 ...
 * @param speed - Optional speed of the pinch gesture.
 */
export async function mobilePinchOpenGesture(percent, elementId, left, top, width, height, speed) {
 ...
 */
export async function mobileSwipeGesture(direction, percent, elementId, left, top, width, height, speed) {
 ...
 * @returns True if further scrolling is possible, false otherwise.
 */
export async function mobileScrollGesture(direction, percent, elementId, left, top, width, height, speed) {
...
export async function mobileScrollBackTo(elementId, elementToId) {
    ...
    await this.uiautomator2.jwproxy.command(`/appium/element/${util.unwrapElement(elementId)}/scroll_to/${util.unwrapElement(elementToId)}`, 'POST', {});
}
/**
 ...
 */
export async function mobileScroll(strategy, selector, elementId, maxSwipes) {
