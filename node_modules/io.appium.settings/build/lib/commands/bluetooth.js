import { BLUETOOTH_SETTING_ACTION, BLUETOOTH_SETTING_RECEIVER, BLUETOOTH_UNPAIR_ACTION, BLUETOOTH_UNPAIR_RECEIVER, } from '../constants.js';
/**
...
export async function unpairAllBluetoothDevices() {
    await this.checkBroadcast(['-a', BLUETOOTH_UNPAIR_ACTION, '-n', BLUETOOTH_UNPAIR_RECEIVER], 'unpair all bluetooth devices');
}
