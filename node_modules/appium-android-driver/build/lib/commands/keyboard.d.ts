 ...
 */
export declare function hideKeyboard(this: AndroidDriver): Promise<boolean>;
/**
 ...
 */
export declare function isKeyboardShown(this: AndroidDriver): Promise<boolean>;
/**
 ...
 */
export declare function keys(this: AndroidDriver, keys: string | string[]): Promise<void>;
/**
 * Sends keys to the active element.
 *
 ...
 */
export declare function doSendKeys(this: AndroidDriver, params: SendKeysOpts): Promise<void>;
/**
 ...
 */
export declare function keyevent(this: AndroidDriver, keycode: string | number, metastate?: number): Promise<void>;
/**
 ...
 * @throws {errors.NotImplementedError} This method is not implemented.
 */
export declare function pressKeyCode(this: AndroidDriver, keycode: string | number, metastate?: number): Promise<void>;
/**
 ...
 * @throws {errors.NotImplementedError} This method is not implemented.
 */
export declare function longPressKeyCode(this: AndroidDriver, keycode: string | number, metastate?: number): Promise<void>;
/**
 ...
 */
export declare function mobilePerformEditorAction(this: AndroidDriver, action: string | number): Promise<void>;
/**
