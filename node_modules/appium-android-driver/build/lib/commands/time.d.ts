 ...
 */
export declare function getDeviceTime(this: AndroidDriver, format?: string): Promise<string>;
/**
 * Gets the current device time.
 *
 ...
 * @returns Promise that resolves to the formatted device time string.
 */
export declare function mobileGetDeviceTime(this: AndroidDriver, format?: string): Promise<string>;
/**
 ...
 */
export declare function adjustTimeZone(this: AndroidDriver, zoneName: string): Promise<void>;
