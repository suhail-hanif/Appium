 ...
 */
export declare function launchApp(this: AndroidDriver): Promise<void>;
/**
 ...
 * @throws {errors.UnsupportedOperationError} This API is not supported anymore.
 */
export declare function closeApp(this: AndroidDriver): Promise<void>;
/**
 ...
 * @throws {errors.UnsupportedOperationError} This API is not supported anymore.
 */
export declare function reset(this: AndroidDriver): Promise<void>;
