...
import type { ConnectedDevicesOptions, Device, VerboseDevice, AvdLaunchOptions, Version, RootResult, ShellExecOptions, SpecialAdbExecOptions, ExecResult } from './types.js';
 ...
 */
export declare function getConnectedDevices(this: ADB, opts: ConnectedDevicesOptions & {
    verbose: true;
 ...
 */
export declare function adbExec(this: ADB, cmd: string | string[], opts: AdbExecOptions & {
    outputFormat: 'full';
}): Promise<ExecResult>;
/**
 * Execute the given adb command.
 ...
 * @throws {Error} If command execution fails or timeout is exceeded
 */
export declare function adbExec(this: ADB, cmd: string | string[], opts?: AdbExecOptions): Promise<string>;
/**
 ...
 */
export declare function shell(this: ADB, cmd: string | string[], opts: ShellExecOptions & {
    outputFormat: 'full';
}): Promise<ExecResult>;
/**
 * Execute the given command using _adb shell_ prefix.
 ...
 * @throws {Error} If command execution fails
 */
export declare function shell(this: ADB, cmd: string | string[], opts?: ShellExecOptions): Promise<string>;
/**
 ...
 */
export declare function getConnectedEmulators(this: ADB, opts: ConnectedDevicesOptions & {
    verbose: true;
}): Promise<VerboseDevice[]>;
/**
 * Retrieve the list of currently connected emulators.
