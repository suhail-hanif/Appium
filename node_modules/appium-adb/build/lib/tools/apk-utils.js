...
export async function installOrUpgrade(appPath, pkg = null, options = {}) {
    if (!pkg) {
        ...
        if ('name' in apkInfo) {
            ...
            log.warn(`Cannot determine the package name of '${appPath}'. ` +
...
export async function extractStringsFromApk(appPath, language = null, outRoot = null) {
    ...
    try {
        ...
        try {
            ...
            const error = e;
            throw new Error(`Cannot extract resources from '${originalAppPath}'. ` + `Original error: ${error.message}`, { cause: e });
        }
    }
