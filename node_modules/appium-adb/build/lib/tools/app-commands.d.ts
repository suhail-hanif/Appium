...
import type { StringRecord, InstallState, ResolveActivityOptions, IsAppInstalledOptions, StartUriOptions, StartAppOptions, AppInfo, PackageActivityInfo, ListInstalledPackagesOptions, ListInstalledPackagesResult } from './types.js';
 ...
 */
export declare function assertSafeComponentName(value: string, kind: string): void;
/**
