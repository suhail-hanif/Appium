    ...
    properties: {
        ...
        server: {
            ...
            properties: {
                ...
                'max-ipc-topics': {
                    appiumCliDescription: 'The maximum number of IPC topics allowed per session.',
                    description: 'Maximum number of IPC topics per session',
                    type: 'integer',
                    minimum: 1,
                    default: 1000,
                    title: 'max-ipc-topics config',
                },
            },
            title: 'server config',
            type: 'object',
