 ...
 */
export type IpcData = null | undefined | string | number | boolean | bigint | Date | RegExp | Error | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ReadonlyArray<IpcData> | ReadonlyMap<IpcData, IpcData> | ReadonlySet<IpcData> | {
    [key: string]: IpcData;
};
/**
