...
class BaseDriver extends core_1.DriverCore {
    ...
    validateDesiredCaps(caps) {
        ...
        try {
            ...
            throw this.log.errorWithException(new protocol_1.errors.SessionNotCreatedError(`Session capabilities were not valid for the ` + `following reason(s): ${capError.message}`, capError));
        }
